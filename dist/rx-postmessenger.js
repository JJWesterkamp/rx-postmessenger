(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		...
		define("RxPostMessenger", [], factory);
	else if(typeof exports === 'object')
		exports["RxPostMessenger"] = factory();
	else
		root["RxPostMessenger"] = factory();
})(this, function() {
...
var _observable = __webpack_require__(38);
...
var RxPostMessenger = function () {
     ...
     */
    function RxPostMessenger(otherWindow, origin, otherWindowRelation) {
        var _this = this;

        (0, _classCallCheck3.default)(this, RxPostMessenger);

        this.otherWindow = otherWindow;
        this.origin = origin;
        this.otherWindowRelation = otherWindowRelation;
        this.inboundMessages$ = _observable2.default.fromEvent(window, 'message').filter(function (message) {
            return _this.isValidMessage(message);
        }).pluck('data');
    ...
    (0, _createClass3.default)(RxPostMessenger, [{
        key: 'request',
         ...
         */
        value: function request(channel) {
            var payload = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : null;

            var requestData = this.createMessageObject('request', channel, payload);
        ...
        key: 'createResponseObservable',
        value: function createResponseObservable(requestId) {
        ...
        key: 'respond',
        value: function respond(requestId, channel, payload) {
            var responseData = this.createMessageObject('response', channel, payload);
        ...
        key: 'notify',
        value: function notify(channel, payload) {
            var notificationData = this.createMessageObject('notification', channel, payload);
        ...
        value: function createMessageObject(type, channel, payload) {
            return { id: (0, _uuidGenerator2.default)(), type: type, channel: channel, payload: payload };
        }
        /**
         *
         * @param {string} channel
        ...
        key: 'notificationStream',
        value: function notificationStream(channel) {
        ...
        key: 'messagesOfType',
        value: function messagesOfType(type) {
            return this.inboundMessages$.filter(function (message) {
        ...
        key: 'connectWithParent',
        value: function connectWithParent(otherWindow, origin) {
            return new this(otherWindow, origin, 'parent');
        }
    }, {
        key: 'connectWithChild',
        value: function connectWithChild(otherWindow, origin) {
...
exports.default = RxPostMessenger;
...
module.exports = __webpack_require__(2).Observable;
...
var microtask = __webpack_require__(33)();
...
//# sourceMappingURL=rx-postmessenger.js.map