/// <reference types="../node_modules/rxjs/Rx" />

import generateUUID from './uuid-generator';

type OtherWindowRelation = 'parent' | 'child';
...
export default class RxPostMessenger {
    ...
    static connectWithParent(otherWindow: Window, origin: string) {
        return new this(otherWindow, origin, 'parent');
    }

    static connectWithChild(otherWindow: Window, origin: string) {
